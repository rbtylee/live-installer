...
class InstallerEngine:
    ...
    def finish_installation(self):
        ...
        # Perform OS adjustments (unused in BL7.0)
        if os.path.exists("/target/usr/lib/bodhi/bodhiSystem/bodhi-adjust.py"):
            self.do_run_in_chroot("/usr/lib/bodhi/bodhiSystem/bodhi-adjust.py")
        ...
        self.do_run_in_chroot('echo "# Do Not Edit" > /etc/apt/sources.list')
