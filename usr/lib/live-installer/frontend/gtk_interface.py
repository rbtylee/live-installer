...
class InstallerWindow:
    ...
    def i18n(self):
        ...
        # Welcome page
        self.builder.get_object("label_welcome1").set_text(_("Welcome to %s!") % f"Bodhi Linux {VERSION}")
            ...
            if(sel == self.PAGE_LANGUAGE):
                ...
                if not found_root_partition:
                    ErrorDialog(_("Installer"), "<b>%s</b>" % _("Please select a root (/) partition."), _(
                        "A root partition is needed to install Bodhi Linux on.\n\n"
